...
{
    k210_gpiohs_set_direction(DCX_GPIONUM, true);
    k210_gpiohs_set_value(DCX_GPIONUM, true);
}

static void set_dcx_control(void)
{
    k210_gpiohs_set_value(DCX_GPIONUM, false);
}
...
{
    k210_gpiohs_set_direction(RST_GPIONUM, true);
    k210_gpiohs_set_value(RST_GPIONUM, false);
    usleep(100000);
    k210_gpiohs_set_value(RST_GPIONUM, true);
    usleep(100000);
}
